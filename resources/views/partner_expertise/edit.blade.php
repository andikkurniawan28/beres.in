    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route("partner.update", $partner->id) }}" method="POST">
                ...
                <div class="form-group">
                    <label for="phone_number">{{ ucfirst('phone number') }}</label>
                    <input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="Enter phone number..." value="{{ $partner->phone_number }}" required>
                    <input type="hidden" name="old_phone_number" value="{{ $partner->phone_number }}">
                </div>
                <div class="form-group">
